...
<nav className='h-10 w-full bg-black flex '>
  <p className='text-[#818085] cursor-pointer ml-5 hover:text-[#BBD7EC]'>Tomorrow</p>
    <p className='text-[#818085] ml-5 cursor-pointer hover:text-[#BBD7EC]'>Today</p>
<h4 className='text-white/90  ml-5 cursor-pointer  hover:text-[#BBD7EC]'>Next 7days</h4>
{/* <div className="hidden md:flex h-8 w-[12rem] rounded-full bg-[#1E1E1E] gap-2 cursor-pointer fixed right-[15rem] ">
...
<p className="text-white mr-0 md:mr-26 md:ml-0 ml-5 ">Chance Of Rain</p>
