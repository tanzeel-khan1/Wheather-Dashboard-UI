        ...
        <div className="w-full h-[9.5rem] flex">
          <div className="h-full w-[55%]  ">
            ...
            <p className="text-sm ml-2">
              Wind N-E. <span className="text-black">6-7 km/h</span>
            </p>
            <p className="ml-2">
              {" "}
              Pressure <span className="font-medium">100MB</span>
            </p>
            <p className="ml-2">
              {" "}
              Humidity <span className="font-medium">51%</span>
            </p>
          </div>
          <div className="h-full w-[45%] ">
            ...
            <p className="m">
              {" "}
              Sunrise <span className="font-medium pt-12">5:30AM</span>
            </p>
            <p className="m">
              {" "}
              Sunset <span className="font-medium"> 6:45</span>
            </p>
          </div>
        </div>
      </div>
